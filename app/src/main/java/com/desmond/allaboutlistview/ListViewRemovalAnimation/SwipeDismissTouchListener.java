 ...
 * dismissable when the user swipes (drags her finger) horizontally across the view.
 *
 ...
 * {@link android.support.v4.app.ListFragment}, use {@link SwipeDismissListViewTouchListener} instead.</em></p>
 *
 * <p>Example usage:</p>
 *
 * <pre>
